...
class MyTestCase(unittest.TestCase):
    ...
    def test_calculator_return_product(self):
        self.assertEqual(4, self.calculator.Product(2, 2))

    def test_calculator_return_quotient(self):
        self.assertEqual(2, self.calculator.Quotient(4, 2))

    def test_calculator_return_power(self):
        self.assertEqual(16, self.calculator.Power(4, 2))

    def test_calculator_return_Logarithm(self):
        self.assertEqual(3, self.calculator.Log(2, 8))
